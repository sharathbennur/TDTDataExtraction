classdef TDTPipeOnline_4App < handle
%
% Usage:
%     app.TDTPipeOnline_4App

  properties
      AppPath = {'/TDTPipeOnline_4'};
	  AppClass = 'TDTPipeOnline_4App';
	  AppHandle;
	  AppCount = 0;
      Increment = 1;
	  Decrement = 0;
  ...
  methods
    ...
    function obj = TDTPipeOnline_4App()      
    ...
    function startApp(obj)
        ...
        if nargout(@TDTPipeOnline_4) == 0  
            eval('TDTPipeOnline_4');
        else
			obj.AppHandle = eval('TDTPipeOnline_4');   
        end 
        % Increment the reference count by one    
        TDTPipeOnline_4App.refcount(obj.Increment);
